...
HD_PWD='C:/Users/User/Desktop/verilog/Lab7/lab_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab7.tcl
