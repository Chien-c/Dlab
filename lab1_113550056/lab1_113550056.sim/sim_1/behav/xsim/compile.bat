...
REM
REM Generated by Vivado on Fri Sep 12 14:28:17 +0800 2025
...
echo "xvlog --incr --relax -prj SeqMultiplier_tb_vlog.prj"
call xvlog  --incr --relax -prj SeqMultiplier_tb_vlog.prj -log xvlog.log
